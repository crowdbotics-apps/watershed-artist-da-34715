...
## Project Structure
    ...
    ├── watershed_artist_da_34715  # Django project configurations
...
1. Clone this repo and `cd watershed_artist_da_34715`
...
2. Clone this repo and `cd watershed_artist_da_34715`
